defmodule AyomosBlogWeb.PostControllerTest do
  use AyomosBlogWeb.ConnCase

  import AyomosBlog.BlogFixtures

  @create_attrs %{title: "some title", body: "some body", slug: "some slug", excerpt: "some excerpt", published: true, published_at: ~U[2026-01-18 06:51:00Z]}
